...
getChart();
  ...
  return (
    ...
    <div id='c'>
        ...
        <Button type="primary"  className={styles.button1} onClick={GoToLogin} shape="round"  icon={<LogoutOutlined />} >登录</Button>            
        <Button type="primary"  className={styles.button2} onClick={GoToStart} shape="round"  icon={<PlayCircleOutlined />} >快速开始</Button>
