...
//         word.push(Chart_data[k]);
        
       
// }
//     // Chart_data.forEach((index,item)=>{
//     //     word.push(item.title);
//     //     hotd.push(item.url);
//     // })
//     console.log(word);
//     if(word.length!=0){
//         for(let i=0;i<10;i++){
//             word2.push(word[0][i].title);
//             hotd.push(word[0][i].url)
//         }
...
return (
    ...
    <Carousel autoplay className={styles.Carousel} autoplay autoplaySpeed="20" > 
               
                <div className={styles.Carousel2} >
                    <img style={contentStyle } src={require('../../assets/yay.jpg')}  alt="logo"  className={styles.imgg}/>
                </div>
                <div className={styles.Carousel2}>
                    <img style={contentStyle } src={require('../../assets/banner01.jpg')}  alt="logo"  className={styles.imgg}/>
                </div>
